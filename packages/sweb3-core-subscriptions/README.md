...
```bash
npm install sweb3-core-subscriptions
```
...
Then include `dist/sweb3-core-subscriptions.js` in your html file.
...
```js
// in node.js
var Web3Subscriptions = require('sweb3-core-subscriptions');
