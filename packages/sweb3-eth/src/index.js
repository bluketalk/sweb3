...
var Subscriptions = require('sweb3-core-subscriptions').subscriptions;
var Method = require('sweb3-core-method');
var utils = require('sweb3-utils');

var BaseContract = require('sweb3-eth-contract');
var Iban = require('sweb3-eth-iban');
...
var Eth = function Eth() {
    ...
    // sweb3-eth would subsequently change the provider for _all_ contract
    // instances!
    var self = this;
    ...
    // make our proxy Contract inherit from sweb3-eth-contract so that it has all
        ...
        new Subscriptions({
            ...
            subscriptions: {
                ...
                'logs': {
                    ...
                    inputFormatter: [formatter.inputLogFormatter],
                    outputFormatter: formatter.outputLogFormatter,
                    // DUBLICATE, also in sweb3-eth-contract
