...
```bash
npm install sweb3-core-requestmanager
```
...
Then include `dist/sweb3-core-requestmanager.js` in your html file.
...
var Web3RequestManager = require('sweb3-core-requestmanager');
